...
async function debugAutoblock() {
  ...
  try {
    ...
    const userResult = await pool.query(`
      ...
      FROM users 
      WHERE handle LIKE '%fema.monster%' OR did LIKE '%fema%'
    `);
    ...
    const targetList = listsResult.rows.find(list => 
    ...
    processedResult.rows.forEach(block => {
